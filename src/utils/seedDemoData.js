...
const demoUsers = [
  { nome: 'Usuario Demo', email: 'demo@intellistock.com', senha: '123456' },
...
const demoMateriais = [
  ...
  { codigo_barras: '7891234000034', nome: 'Chapa de Aco 2mm', fornecedor: 'Aco Forte Chapas', quantidade_atual: 8, quantidade_minima: 20, preco_custo: 39.90, margem_lucro: 22, preco_manual: 48.90 },
  { codigo_barras: '7891234000041', nome: 'Cabo Eletrico 2.5mm (metro)', fornecedor: 'EletroCabos Brasil', quantidade_atual: 0, quantidade_minima: 50, preco_custo: 2.90, margem_lucro: 29, preco_manual: 3.75 },
  { codigo_barras: '7891234000058', nome: 'Luva de Protecao par', fornecedor: 'SegMais EPIs', quantidade_atual: 15, quantidade_minima: 10, preco_custo: 9.20, margem_lucro: 30, preco_manual: 12.00 },
  { codigo_barras: '7891234000065', nome: 'Tinta Spray Preta 400ml', fornecedor: 'Quimica Rapida', quantidade_atual: 4, quantidade_minima: 10, preco_custo: 14.00, margem_lucro: 32, preco_manual: 18.50 },
...
const demoMovimentacoes = [
  { codigo_barras: '7891234000010', tipo_movimento: 'CADASTRO', quantidade_delta: 250, quantidade_anterior: 0, quantidade_atual: 250, usuario_nome: 'Mariana', observacao: 'Carga inicial do catalogo demo' },
  { codigo_barras: '7891234000027', tipo_movimento: 'CADASTRO', quantidade_delta: 180, quantidade_anterior: 0, quantidade_atual: 180, usuario_nome: 'Mariana', observacao: 'Carga inicial do catalogo demo' },
  { codigo_barras: '7891234000034', tipo_movimento: 'AJUSTE', quantidade_delta: -12, quantidade_anterior: 20, quantidade_atual: 8, usuario_nome: 'Caio', observacao: 'Baixa apos separacao de pedido' },
  { codigo_barras: '7891234000041', tipo_movimento: 'AJUSTE', quantidade_delta: -50, quantidade_anterior: 50, quantidade_atual: 0, usuario_nome: 'Rafaela', observacao: 'Consumo total em manutencao' },
  { codigo_barras: '7891234000058', tipo_movimento: 'CADASTRO', quantidade_delta: 15, quantidade_anterior: 0, quantidade_atual: 15, usuario_nome: 'Diego', observacao: 'Carga inicial do catalogo demo' },
  ...
  { codigo_barras: '7891234000072', tipo_movimento: 'CADASTRO', quantidade_delta: 32, quantidade_anterior: 0, quantidade_atual: 32, usuario_nome: 'Mariana', observacao: 'Carga inicial do catalogo demo' }
];

const demoInsumos = [
  { nome: 'Resina Epoxi', preco_custo_un: 42.75, qtd_atual: 180.5, unidade: 'kg', fornecedor_nome: 'Pesca Quimica LTDA', tempo_espera_dias: 8, ponto_pedido: 120, consumo_medio_diario: 11.5, qtd_seguranca_minima: 28 },
  ...
  { nome: 'Glitter Holografico', preco_custo_un: 18.2, qtd_atual: 0, unidade: 'g', fornecedor_nome: 'ColorMix Brasil', tempo_espera_dias: 5, ponto_pedido: 30, consumo_medio_diario: 3.5, qtd_seguranca_minima: 12.5 },
